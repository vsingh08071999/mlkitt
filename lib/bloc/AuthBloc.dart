import 'dart:convert';
import 'dart:core';
import 'package:mlkit_demo/loginScreen/ActivationScreen.dart';
...
import 'package:mlkit_demo/constants/global.dart';
...
class AuthBloc extends Bloc<AuthBlocEvent, AuthBlocState> {
  ...
  Future<UserData> signInWithEmailAndPassword(
    ...
    await _getUserDatatoFirestore(authResult.uid);
...
//   }
  ...
  Future<UserData> _getUserDatatoFirestore(String uid) async {
    var path = USERS;
    var documentReference = _firestore.collection(path).doc(uid);
